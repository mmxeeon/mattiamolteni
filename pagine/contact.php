...
<head>
    ...
    <title>Contatti - Mattia Molteni</title>
...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul id="main-menu">
                ...
                <li><a href="contact.php" class="active">Contatti</a></li>
            </ul>
        </nav>
        <h1 style="text-align:center; font-size:2.5rem; font-weight:900; color:var(--accent); letter-spacing:1.5px; margin: 32px 0 0 0; text-shadow:0 2px 12px #2563eb22;">Contattami</h1>
    </header>
    ...
    <main>
        <section class="contact-section fade-in">
            ...
            <p>Oppure scrivimi direttamente a <a href="mailto:matti.molte@gmail.com">matti.molte@gmail.com</a></p>
